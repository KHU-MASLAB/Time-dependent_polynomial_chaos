...
%      time dependent polynomial chaosm, long time evaluation
%
%      Reference:
%
...
if(exist("result/MC_"+filenameMC+".mat",'file'))
    ...
    save("result/MC_"+filenameMC+".mat","t_MC","mean_MC","var_MC","skew_MC","kurt_MC",...
...
if(exist("result/PC_"+filename+".mat",'file'))
    ...
    tic
    [E, Ephi2, E_L2, E1, E2, E3, E4,t_PC,mean_PC,var_PC,skew_PC,kurt_PC,thSample_PC,dthSample_PC]...
    = PC(Distribution,Npoint,P,o,h,loc,wts,Lb,Ld,theta,tspan,opts,m,g,basis_sample);
    runtime_PC = toc;
    fprintf('PC finished, runtime : %f\n',runtime_PC)
    save("result/PC_"+filename+".mat","t_PC","mean_PC","var_PC","skew_PC","kurt_PC",...
...
if(exist("result/TDPC_"+filename+".mat",'file'))
    ...
    tic
    [t_TDPC,mean_TDPC,var_TDPC,skew_TDPC,kurt_TDPC,thSample_TDPC,dthSample_TDPC,Nupdate]...
     = TDPC(endtime,stopcrt_t,tspan,E,E1,E2,E3,E4,E_L2,basis_sample,xi_sample,...
            theta,h,o,Lb,Ld,g,m,TD_sample);
    runtime_TDPC = toc;
    fprintf('TD-PC finished, runtime : %f, Nupdate : %f\n',runtime_TDPC,Nupdate)
    save("result/TDPC_"+filename+".mat","t_TDPC","mean_TDPC","var_TDPC","skew_TDPC","kurt_TDPC",...
        "thSample_TDPC","dthSample_TDPC");
end
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%% Plot %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

%% result plot
plot_moments(t_MC,t_PC,t_TDPC,mean_MC,mean_PC,mean_TDPC,"mean")
% plot_moments(t_MC,t_PC,t_TDPC,var_MC,var_PC,var_TDPC,"Variance")
% plot_moments(t_MC,t_PC,t_TDPC,real(skew_MC),skew_PC,skew_TDPC,"Skewness")
% plot_moments(t_MC,t_PC,t_TDPC,real(kurt_MC),kurt_PC,kurt_TDPC,"Kurtosis")
%% Error plot
plotall_Error(t_PC,t_TDPC,mean_MC,mean_PC,mean_TDPC,"mean")
% plotall_Error(t_PC,t_TDPC,var_MC,var_PC,var_TDPC,"Variance")
% plotall_Error(t_PC,t_TDPC,real(skew_MC),skew_PC,skew_TDPC,"Skewness")
% plotall_Error(t_PC,t_TDPC,real(kurt_MC),kurt_PC,kurt_TDPC,"Kurtosis")
